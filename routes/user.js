...
router.get('/delete/:id',userControler.getdelete); //logout    

router.get('/edit/:id',userControler.getedit); //logout

 router.post('/update/:id',userControler.getupdate); //logout   
 router.get('/categorydisp',userControler.getalert);// get show status
